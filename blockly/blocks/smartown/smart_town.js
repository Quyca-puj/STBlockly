...
Blockly.Blocks[Blockly.SmartTown.BLOCK_ST_AVANZAR] = {
  init: function () {
    this.jsonInit(
      {
        "message0": "Avanzar",
...
Blockly.Blocks[Blockly.SmartTown.BLOCK_ST_GIRAR] = {
  init: function () {
    this.jsonInit(
      {
...
Blockly.Blocks[Blockly.SmartTown.BLOCK_ST_GIRAR_T] = {
  init: function () {
    this.jsonInit(
      {
...
Blockly.Blocks[Blockly.SmartTown.BLOCK_ST_HABLAR] = {
  init: function () {
...
Blockly.Blocks[Blockly.SmartTown.BLOCK_ST_SETUP] = {
  init: function () {
    this.appendDummyInput()
...
Blockly.Blocks[Blockly.SmartTown.BLOCK_ST_COMMAND] = {
  init: function () {
    this.jsonInit(
      {
