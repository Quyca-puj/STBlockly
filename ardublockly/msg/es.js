...
Ardublockly.LOCALISED_TEXT = {
  ...
  noCharacOriginTitle:"¡No has asignado un personaje al nodo origen!",
  noCharacDestinationTitle:"¡No has asignado un personaje al nodo destinado!",
  noCharacBody:"Dale doble click al nodo y selecciona un personaje.",
  invalidConnectionTitle:"¡No se pueden conectar esas acciones!",
  invalidConnectionBody:"Revisa que ambas acciones no compartan recursos.",
  invalidConnectionActionTitle:"¡No has asignado una accion al nodo seleccionado!",
  invalidConnectionActionBody:"Dale doble click al nodo y selecciona un accion.",
  noNetNodesTitle:"¡No has agregado ninguna acción!",
  noNetNodesBody:"Agrega una nueva acción dándole al botón",
};
